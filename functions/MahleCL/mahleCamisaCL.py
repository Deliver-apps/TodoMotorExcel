...
from constants.empresas import MAHLE_CAMISA_CL
from utils.requiredColumns import get_required_columns
from utils.mahleRefCL import ref_mahle_cl

def case_mahle_camisa_cl(archivo_excel, messagebox):
        columnas = get_required_columns(MAHLE_CAMISA_CL)
        ...
        guardar_df_en_excel(df_repetido, 'mahle_camisa_cl')
