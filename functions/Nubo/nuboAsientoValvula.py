...
from constants.empresas import NUBO_ASIENTO_VALVULA
from utils.requiredColumns import get_required_columns

def case_nubo_asiento_valvula(archivo_excel, messagebox):   
        columnas = get_required_columns(NUBO_ASIENTO_VALVULA)
