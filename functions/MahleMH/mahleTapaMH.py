...
from constants.empresas import MAHLE_TAPAS_MH
from utils.requiredColumns import get_required_columns

def case_mahle_tapas(archivo_excel, messagebox):
        columnas = get_required_columns(MAHLE_TAPAS_MH)
        ...
        guardar_df_en_excel(df_repetido, 'mahle_tapas_mh')
