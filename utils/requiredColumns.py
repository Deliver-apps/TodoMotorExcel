...
def get_required_columns(opcion):
    ...
    opciones = {
        ...
        MAHLE_AROS_PC: ['APLICACION', 'MEDIDAS', 'PRECIO RECAMBIO', 'PRECIO RECTIF', 'RECTIF', 'RECAMBIO'],
        ...
        #FEDERAL
        FEDERAL_SUBCONJUNTOS: ['APLICACIÓN','MEDIDAS', 'CÓDIGO', 'PRECIO LISTA'],
        FEDERAL_COJINETES: ['APLICACIÓN', 'MEDIDAS', 'MODELO', 'CODIGO', 'PRECIO LISTA'],
        FEDERAL_BUJE: ['APLICACIÓN', 'MEDIDAS', 'CÓDIGO', 'PRECIO LISTA'],
        FEDERAL_PISTONES: ['APLICACIÓN', 'MEDIDAS', 'CÓDIGO', 'PRECIO LISTA'],
        FEDERAL_AROS: ['APLICACIÓN', 'MEDIDA', 'CODIGO', 'PRECIO LISTA'],
